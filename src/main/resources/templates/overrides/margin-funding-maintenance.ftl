      ...
      <div class="content-card">
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Margin funding actions" rightSectionLabel="Grid manager view actions">
            ...
            <div class="gt-view-actions">
              <button type="button" class="gt-view-btn" data-density="comfortable" aria-label="Comfortable rows" title="Comfortable rows">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M3 6H21M3 12H21M3 18H21" />
                </svg>
              </button>

              <button type="button" class="gt-view-btn is-active" data-density="compact" aria-label="Compact rows" title="Compact rows">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M3 6H21M3 12H21M3 18H21" />
                </svg>
              </button>

              <button type="button" class="gt-view-btn" data-density="spacious" aria-label="Spacious rows" title="Spacious rows">
                <svg viewBox="0 0 24 24" aria-hidden="true">
